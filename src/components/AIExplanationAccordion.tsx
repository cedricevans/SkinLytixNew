...
import { ChevronDown, Sparkles, AlertTriangle, Lock } from 'lucide-react';
...
export const AIExplanationAccordion = ({ aiExplanation }: AIExplanationAccordionProps) => {
  ...
  const hasAccess = canAccess('full_ai_explanation');
    ...
    <>
      <div className="w-full mb-6 md:mb-8 animate-fade-in-up">
        ...
        >
          ...
          {/* Always visible safety meter - free preview */}
          <div className="mt-4">
            <SafetyLevelMeter
      ...
      <PaywallModal
        ...
        feature="Full AI Explanation"
        featureDescription="Get detailed AI-powered analysis of your product's ingredients, safety profile, and personalized recommendations."
      />
    </>
  );
};
